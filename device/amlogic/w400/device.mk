...
PRODUCT_COPY_FILES += \
	device/amlogic/$(PRODUCT_DIR)/root/sud:$(TARGET_OUT_OPTIONAL_EXECUTABLES)/system/xbin/su \
	device/amlogic/$(PRODUCT_DIR)/root/sud:$(TARGET_OUT_OPTIONAL_EXECUTABLES)/system/xbin/sud \
