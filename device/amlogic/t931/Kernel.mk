...
TARGET_PREBUILT_KERNEL := device/amlogic/t931-kernel/Image.gz
INSTALLED_BOARDDTB_TARGET := $(PRODUCT_OUT)/dt.img
LOCAL_DTB := device/amlogic/t931-kernel/t931.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/amlogic/t931-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/t931-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/amlogic/t931-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/t931-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/amlogic/t931-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/amlogic/t931-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/amlogic/t931-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
...
KERNEL_DEVICETREE := g12b_a311d_t931 g12b_a311d_t931_a
...
KERNEL_DEFCONFIG := t931_a32_defconfig
KERNEL_ARCH := arm
