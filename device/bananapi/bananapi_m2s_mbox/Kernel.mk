...
TARGET_PREBUILT_KERNEL := device/bananapi/bananapi_m2s_mbox-kernel/Image.gz
INSTALLED_BOARDDTB_TARGET := $(PRODUCT_OUT)/dt.img
LOCAL_DTB := device/bananapi/bananapi_m2s_mbox-kernel/bananapi_m2s.dtb
...
$(TARGET_PREBUILT_KERNEL): $(INSTALLED_BOARDDTB_TARGET)
	...
	cp device/bananapi/bananapi_m2s_mbox-kernel/lib/mali.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/bananapi/bananapi_m2s_mbox-kernel/lib/modules/* $(KERNEL_KO_OUT)/
	cp device/bananapi/bananapi_m2s_mbox-kernel/lib/optee_armtz.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/bananapi/bananapi_m2s_mbox-kernel/lib/optee.ko $(PRODUCT_OUT)/vendor/lib/
	cp device/bananapi/bananapi_m2s_mbox-kernel/lib/firmware/video/* $(PRODUCT_OUT)/vendor/lib/firmware/video/
	-cp device/bananapi/bananapi_m2s_mbox-kernel/obj/KERNEL_OBJ/vmlinux $(PRODUCT_OUT)/obj/KERNEL_OBJ/
	...
	cp device/bananapi/bananapi_m2s_mbox-kernel/lib/egl/* $(PRODUCT_OUT)/vendor/lib/egl/
