...
#panel + hdmi
LCD_HWC_DISPLAY_NUM := 2
LCD_HWC_PIPELINE := "dual"
LCD_HWC_PRIMARY_FRAMEBUFFER_WIDTH := 800
LCD_HWC_PRIMARY_FRAMEBUFFER_HEIGHT := 1280
LCD_HWC_EXTEND_FRAMEBUFFER_WIDTH := 1920
LCD_HWC_EXTEND_FRAMEBUFFER_HEIGHT := 1080
LCD_HWC_PRIMARY_CONNECTOR_TYPE := "panel"
LCD_HWC_EXTEND_CONNECTOR_TYPE := "hdmi-only"
