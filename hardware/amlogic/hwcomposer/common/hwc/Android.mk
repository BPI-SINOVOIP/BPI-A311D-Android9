...
ifneq ($(LCD_HWC_DISPLAY_NUM),)
    LOCAL_CFLAGS += -DLCD_HWC_DISPLAY_NUM=$(LCD_HWC_DISPLAY_NUM)
endif
...
ifneq ($(LCD_HWC_PIPELINE),)
    LOCAL_CFLAGS += -DLCD_HWC_PIPELINE=\"$(LCD_HWC_PIPELINE)\"
endif
...
ifneq ($(LCD_HWC_PRIMARY_FRAMEBUFFER_WIDTH)$(LCD_HWC_PRIMARY_FRAMEBUFFER_HEIGHT),)
    LOCAL_CFLAGS += -DLCD_HWC_PRIMARY_FRAMEBUFFER_WIDTH=$(LCD_HWC_PRIMARY_FRAMEBUFFER_WIDTH)
    LOCAL_CFLAGS += -DLCD_HWC_PRIMARY_FRAMEBUFFER_HEIGHT=$(LCD_HWC_PRIMARY_FRAMEBUFFER_HEIGHT)
endif
ifneq ($(LCD_HWC_EXTEND_FRAMEBUFFER_WIDTH)$(LCD_HWC_EXTEND_FRAMEBUFFER_HEIGHT),)
    LOCAL_CFLAGS += -DLCD_HWC_EXTEND_FRAMEBUFFER_WIDTH=$(LCD_HWC_EXTEND_FRAMEBUFFER_WIDTH)
    LOCAL_CFLAGS += -DLCD_HWC_EXTEND_FRAMEBUFFER_HEIGHT=$(LCD_HWC_EXTEND_FRAMEBUFFER_HEIGHT)
endif
...
ifneq ($(LCD_HWC_PRIMARY_CONNECTOR_TYPE),)
    LOCAL_CFLAGS += -DLCD_HWC_PRIMARY_CONNECTOR_TYPE=\"$(LCD_HWC_PRIMARY_CONNECTOR_TYPE)\"
endif
ifneq ($(LCD_HWC_EXTEND_CONNECTOR_TYPE),)
    LOCAL_CFLAGS += -DLCD_HWC_EXTEND_CONNECTOR_TYPE=\"$(LCD_HWC_EXTEND_CONNECTOR_TYPE)\"
endif
